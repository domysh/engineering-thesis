...
La vulnerabilità è stata inizialmente segnalata al team di sicurezza del kernel che rapidamente ha rilasciato una patch\footcite{netfilter: nf\_queue: do not allow packet truncation below transport header offset}{cve_2022_36946_patch}.
