...
python3 comparemark.py nfproxy -p testpassword -d 1 -s 50 -V 100 && python3 comparemark.py nfregex -p testpassword -d 1 -s 50 -V 100
\end{minted}
\end{listing}

I benchmark pertanto sono stati eseguiti con 1 secondo di durata della singola misura, 50 connessioni simultanee, e 100 misure eseguite.\\
