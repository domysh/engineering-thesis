...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        \hline
        \textbf{Firewall} & \textbf{0Conf} & \textbf{Easy use} & \textbf{Easy Setup} & \textbf{Flexible}\\
        \hline
        \texttt{Firegex} & 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/chapter2/FiregexFastapiSwagger.png}
    \caption{Swagger Backend generato da FastAPI di Firegex}
    \label{fig:firegex_backend}
\end{figure}
...
(fork di \texttt{hyperscan}\footcite{\url{https://www.intel.com/content/www/us/en/developer/articles/technical/introduction-to-hyperscan.html}}{hyperscan} compatibile con arm64) per garantire prestazioni elevate
